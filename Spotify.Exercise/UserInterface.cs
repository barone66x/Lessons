        ...
        public static void SongPlayer()
        {
            ...
            if (MediaPlayer.GetInstance().currentSong != null)
            {
                ...
                if (MediaPlayer.GetInstance().isPlaying)
                {
                    ...
                    Console.WriteLine($"In riproduzione: {MediaPlayer.GetInstance().currentSong.Title} di {MediaPlayer.GetInstance().currentSong.Artist}");
                }
                else
                {
                    Console.BackgroundColor = ConsoleColor.DarkYellow;
                    Console.WriteLine($"In pausa: {MediaPlayer.GetInstance().currentSong.Title} di {MediaPlayer.GetInstance().currentSong.Artist}");
                }
            }
            Console.ResetColor();
        }
